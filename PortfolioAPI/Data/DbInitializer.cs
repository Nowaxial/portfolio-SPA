...
public static class DbInitializer
{
    public static void Initialize(PortfolioContext context)
    {
        ...
        var translations = new Translation[]
        {
            ...
            new Translation { Key = "Hero.BasedIn", LanguageCode = "en", Value = "Based in Gothenburg, Sweden" },
            ...
            new Translation { Key = "Hero.BasedIn", LanguageCode = "sv", Value = "Baserad i Göteborg, Sverige" },
